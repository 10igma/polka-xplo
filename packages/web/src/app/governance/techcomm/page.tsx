          ...
          <tbody>
            {proposals.map((p) => (
              <tr key={p.proposal_index} className="table-row">
                ...
                <td className="py-2.5 pr-4 text-center text-zinc-300">{p.threshold}</td>
                <td className="py-2.5 pr-4 text-right text-green-400">{p.aye_count}</td>
                <td className="py-2.5 text-right text-red-400">{p.nay_count}</td>
              </tr>
            ))}
            {proposals.length === 0 && (
              <tr>
